...
def rekap_hasil4(request, area_code_lv2, area_code_lv3, area_code_lv4):
    url = DATABASE_API + f'api/rekap-api/{area_code_lv2}/{area_code_lv3}/{area_code_lv4}/'
    response = requests.get(url)
    if response.status_code == 200:
        context = response.json()
...
def rekap_hasil5(request, area_code_lv2, area_code_lv3, area_code_lv4, area_code_lv5):
    url = DATABASE_API + f'api/rekap-api/{area_code_lv2}/{area_code_lv3}/{area_code_lv4}/{area_code_lv5}/'
    response = requests.get(url)
    if response.status_code == 200:
        context = response.json()
