...
def getRoutes(request):
    routes = [
        ...
        "GET /api/rekap/",
        "GET /api/rekap/<str:area_code_lv2>/",
        "GET /api/rekap/<str:area_code_lv2>/<str:area_code_lv3>/",
        "GET /api/rekap/<str:area_code_lv2>/<str:area_code_lv3>/<str:area_code_lv4>/",
        "GET /api/rekap/<str:area_code_lv2>/<str:area_code_lv3>/<str:area_code_lv4>/<str:area_code_lv5>/",
        "GET /api/rekap-api/",
        "GET /api/rekap-api/<str:area_code_lv2>/",
        "GET /api/rekap-api/<str:area_code_lv2>/<str:area_code_lv3>/",
        "GET /api/rekap-api/<str:area_code_lv2>/<str:area_code_lv3>/<str:area_code_lv4>/",
        "GET /api/rekap-api/<str:area_code_lv2>/<str:area_code_lv3>/<str:area_code_lv4>/<str:area_code_lv5>/"
    ]
...
class HasilRekap4API(APIView):
    def get(self, request, area_code_lv2, area_code_lv3, area_code_lv4, format=None):
        ...
        rekap_hasil = DATABASE_API+ f"api/rekap/{area_code_lv2}/{area_code_lv3}/{area_code_lv4}"
        ...
        total_child_data = {}
        for key, value in rekap_hasil_data["table"].items():
            area_code_lv5 = next((item["kode"] for item in wilayah_lv4_data if item["kode"] == key), None)
            area_id = next((item["id"] for item in wilayah_lv4_data if item["kode"] == key), None)
            area_name = next((item["nama"] for item in wilayah_lv4_data if item["kode"] == key), None)
            level = next((item["tingkat"] for item in wilayah_lv4_data if item["kode"] == key), None)
            total_child_data[key] = {
                "code_lv2": area_code_lv2,
                "area_code_lv3": area_code_lv3,
                "area_code_lv4": area_code_lv4,
...
class HasilRekap5API(APIView):
    def get(self, request, area_code_lv2, area_code_lv3, area_code_lv4, area_code_lv5, format=None):
        ...
        rekap_hasil = DATABASE_API+ f"api/rekap/{area_code_lv2}/{area_code_lv3}/{area_code_lv4}/{area_code_lv5}/"
        ...
        wilayah_lv5_data = wilayah_lv5_response.json()
        ...
        total_child_data = {}
        for key, value in rekap_hasil_data["table"].items():
            area_code_lv6 = next((item["kode"] for item in wilayah_lv5_data if item["kode"] == key), None)
            area_id = next((item["id"] for item in wilayah_lv5_data if item["kode"] == key), None)
            area_name = next((item["nama"] for item in wilayah_lv5_data if item["kode"] == key), None)
            level = next((item["tingkat"] for item in wilayah_lv5_data if item["kode"] == key), None)
            total_child_data[key] = {
                "code_lv2": area_code_lv2,
                "area_code_lv3": area_code_lv3,
                "area_code_lv4": area_code_lv4,
