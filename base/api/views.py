...
class Level2API(APIView):
    def get(self, request, area_code_lv2, format=None):
        names_url = "http://127.0.0.1:8000/api/names/"
        wilayah_0_url = "http://127.0.0.1:8000/api/wilayah/0/"
        votes_url = f"http://127.0.0.1:8000/api/votes/{area_code_lv2}/"
        wilayah_url = f"http://127.0.0.1:8000/api/wilayah/{area_code_lv2}/"


        names_response = requests.get(names_url)
        names_data = names_response.json()

        wilayah_0_response = requests.get(wilayah_0_url)
        wilayah_0_data = wilayah_0_response.json()
